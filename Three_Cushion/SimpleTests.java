...
System.out.println("Expected: Player A: 0, Player B: 0, Inning: 1 notstarted");
// The lag winner chooses to take the break shot and take the white cue
...
System.out.println("The shot has started is " + game.isInningStarted() + 
", expected true");
System.out.println("Stats:    " + game);
